  ...
  return (
    <section className={styles.card}>
      <div className={styles.cardHead}>
        <div>
          ...
          <p className={styles.cardHint}>
            ...
            hai — live NIC/GSP ke liye VPS <code>server/.env</code> set karein.
          </p>
        </div>
      ...
      <h3 className={styles.subHead} style={{ marginTop: "1rem" }}>
        Hostinger VPS — server/.env (live GSP)
      </h3>
      <ol className={styles.cardHint} style={{ paddingLeft: "1.2rem", lineHeight: 1.55 }}>
        ...
        <li>Save → VPS pe <code>pm2 restart dhatterwal-erp-api</code></li>
      </ol>
      <p className={styles.cardHint}>
